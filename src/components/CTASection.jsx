    ...
    <section className="py-16 text-white bg-gradient-to-r from-red-600 to-rose-700">
      <div className="container px-4 mx-auto text-center">
        <motion.h2 
          ...
          viewport={{ once: true }}
        >
          Wujudkan Toyota Impian Anda Sekarang!
        </motion.h2>
        <motion.p 
          ...
          viewport={{ once: true }}
        >
          Dapatkan konsultasi gratis dan penawaran eksklusif untuk mobil Toyota pilihan Anda.
        </motion.p>
        
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <motion.a 
            href={`https://wa.me/${salesInfo.phone}?text=Halo%20${salesInfo.name},%20saya%20ingin%20konsultasi%20dan%20penawaran%20terbaik%20Toyota`} 
